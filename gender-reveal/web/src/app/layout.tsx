...
// Read the real PNG dimensions instead of hardcoding them — og.png is regenerated by
// scripts/make-og.mjs and its size can change when the source illustrations change.
function ogImageSize(): { width: number; height: number } {
  const bytes = fs.readFileSync(path.resolve(process.cwd(), 'public/og.png'));
